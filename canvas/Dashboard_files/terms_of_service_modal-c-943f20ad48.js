(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[4027],{"5Og0":function(e,n,t){"use strict"
t.r(n)
var a=t("An8g")
var r=t("3lLS")
var i=t.n(r)
...
t("jQeR")
t("0sPK")
var g=s["default"].scoped("modal")
var h=t("Dibh")
const p=["label","closeButtonLabel","onDismiss","children"]
function u(){return document.getElementById("flash_screenreader_holder")}function f(e){let n=e.label,t=e.closeButtonLabel,i=e.onDismiss,s=e.children,d=Object(r["a"])(e,p)
return o.a.createElement(h["a"],Object.assign({liveRegion:u},d,{label:n,onDismiss:i}),Object(a["a"])(h["a"].Header,{},void 0,Object(a["a"])(c["a"],{"data-testid":"instui-modal-close",placement:"end",offset:"medium",onClick:i},void 0,t||g.t("Close")),Object(a["a"])(l["a"],{},void 0,n)),s)}["Header","Body","Footer"].forEach(e=>f[e]=h["a"][e])
f.defaultProps={closeButtonLabel:void 0}},BrAc:function(e,n,t){"use strict"
var a=t("vDqi")
var r=t.n(a)
...
n["a"]=r.a},Ce78J:function(e,n,t){"use strict"
var a=t("VTBJ")
var r=t("ouhR")
var i=t.n(r)
var o=t("Y/W1")
...
var l=t("JiFB")
var s=t("ik22")
function d(e,n,t){const r=Object(a["a"])({},t)
e.forEach(e=>{const a=n[e]
const i=t[e]
Array.isArray(a)&&Array.isArray(i)&&(r[e]=[...new Set(a.concat(i))])})
return r}function g(e,n,t,r,i){const o=new l["a"](i,s["a"],e,n)
const c=Object(a["a"])({},o.defaultConfig())
return Object(a["a"])(Object(a["a"])({},c),d(t.optionsToMerge||[],c,t.tinyOptions))}var h=g
var p=t("FNQM")
const u={call(e,...n){if("exists?"===e)return true
...
const b={wrapEditor(e){const n=Object(a["a"])(Object(a["a"])({},u),e)
return Object.assign(e,n)},wrapSidebar(e){const n=Object(a["a"])(Object(a["a"])({},f),e)
return Object.assign(e,n)}}
var m=b
var _=t("eVns")
var v=t("stQK")
const y={loadingPromise:null,preload(e){(window.requestIdleCallback||window.setTimeout)(()=>this.loadRCE(e))},loadOnTarget(e,n,t){const a=this.getTargetTextarea(e)
const r=this.getRenderingTarget(a,n.getRenderingTarget)
const i=this.createRCEProps(a,n)
this.loadRCE(e=>{e.renderIntoDiv(r,i,e=>{e.tinymceOn("init",()=>t(a,m.wrapEditor(e)))})})},loadingCallbacks:[],RCE:null,loadRCE(e=(()=>{})){return Promise.all([t.e(2),t.e(3),t.e(5),t.e(6),t.e(8),t.e(11),t.e(12),t.e(13),t.e(14),t.e(20),t.e(25),t.e(35),t.e(3687)]).then(t.bind(null,"j/Fk")).then(e=>{this.RCE=e
Object(p["a"])()
return e}).then(()=>{this.loadingCallbacks.forEach(e=>e(this.RCE))
this.loadingCallbacks=[]
e(this.RCE)})},getTargetTextarea:e=>"textarea"===i()(e).get(0).type?i()(e).get(0):i()(e).find("textarea").get(0),getRenderingTarget(e,n){let t
t="undefined"===typeof n?i()(e).parent().get(0):n(e)
i()(t).addClass("ic-RichContentEditor")
return t},_attrsToMirror(e){const n=["name"]
const t=c.a.reduce(e.attributes,(e,n)=>{e[n.name]=n.value
return e},{})
return c.a.pick(t,n)},createRCEProps(e,n){var t,r,i,o,c
const l=e.offsetWidth
const s=e.offsetHeight||400
s&&(n.tinyOptions=Object(a["a"])({height:s},n.tinyOptions||{}))
const d=ENV.LOCALE
const g=Object.keys(v["a"]).map(e=>({id:e,label:v["a"][e]})).sort((e,n)=>e.id===d?-1:n.id===d?1:e.label.localeCompare(n.label,d))
const p={enabled:true,maxAge:Number.isNaN(ENV.rce_auto_save_max_age_ms)?36e5:ENV.rce_auto_save_max_age_ms}
return{defaultContent:e.value||n.defaultContent,editorOptions:h.bind(null,l,e.id,n,null),language:ENV.LOCALE,mirroredAttrs:this._attrsToMirror(e),onFocus:n.onFocus,onBlur:n.onBlur,textareaClassName:e.className,textareaId:e.id,trayProps:Object(_["a"])(),languages:g,liveRegion:()=>document.getElementById("flash_screenreader_holder"),ltiTools:null===(t=window.INST)||void 0===t?void 0:t.editorButtons,autosave:n.autosave||p,instRecordDisabled:ENV.RICH_CONTENT_INST_RECORD_TAB_DISABLED,maxInitRenderedRCEs:n.maxInitRenderedRCEs,highContrastCSS:null===(r=window.ENV)||void 0===r?void 0:r.url_for_high_contrast_tinymce_editor_css,use_rce_buttons_and_icons:!!(null!==(i=window.ENV)&&void 0!==i&&null!==(o=i.FEATURES)&&void 0!==o&&o.rce_buttons_and_icons),use_rce_a11y_checker_notifications:!!(null!==(c=window.ENV)&&void 0!==c&&c.use_rce_a11y_checker_notifications)}}}
var k=y
var R=t("eodz")
function w(e,n,t){e.css("display","none")
const a=n.onFocus
n.onFocus=(...e)=>{a instanceof Function&&a(...e)}
k.loadOnTarget(e,n,(n,a)=>{const r=S(e)
const o=E(i()(n))
o.data("remoteEditor",a)
r.trigger(R["a"],a)
t&&t(a)})}function x(e){const n=S(e)
const t=n.attr("id")
const a="tinymce-parent-of-"+t
if(n.parent().attr("id")!==a)return n.wrap(`<div id='${a}' style='visibility: hidden'></div>`)}function C(){i()(".mce-resizehandle").attr("aria-hidden",true)}let B=0
function O(){return"random_editor_id_"+B++}function A(e){const n=i()(e)
const t="attr"in n?n.attr("id"):n.id
t&&""!=t||n.attr("id",O())}function E(e){const n=S(e)
const t=n.attr("id")
if(!t||""==t)return n
const a=i()("#"+t)
if(a.length<=0)return n
return a}const F={preloadRemoteModule:(e=(()=>{}))=>k.preload(e),loadNewEditor(e,n={},t){let a=S(e)
if(a.length<=0)return
A(a)
n=i.a.extend({},n)
const r=e=>{n.focus&&this.activateRCE(a)
t&&t(e)}
a=this.freshNode(a)
if(n.manageParent){delete n.manageParent
x(a)}w(a,n,r)
C()},callOnRCE(e,n,...t){let a=S(e)
a=this.freshNode(a)
return Object(R["d"])(a,n,...t)},destroyRCE(e){let n=S(e)
n=this.freshNode(n)
Object(R["b"])(n)},closeRCE(e){this.callOnRCE(e,"RCEClosed")},activateRCE(e){let n=S(e)
n=this.freshNode(n)
Object(R["c"])(n)},freshNode:E,ensureID:A,node2jquery:S}
function S(e){return e&&e.length?e:i()(e)}n["a"]=F},ErZx:function(e,n,t){"use strict"
...
n["a"]=a},ZELe:function(e,n,t){"use strict"
t.d(n,"a",(function(){return a}))
function a(e){return function(n,t,a){var r=n[t]
if(null===r||"undefined"===typeof r)return new Error("The prop `".concat(t,"` is marked as required in `").concat(a,"`, but its value is `").concat(r,"`"))
for(var i=arguments.length,o=new Array(i>3?i-3:0),c=3;c<i;c++)o[c-3]=arguments[c]
return e.apply(void 0,[n,t,a].concat(o))}}},ZbPE:function(e,n,t){"use strict"
...
var C=(y=Object(u["l"])(v,x),y(k=(w=R=function(e){Object(o["a"])(t,e)
var n=Object(c["a"])(t)
function t(){Object(r["a"])(this,t)
return n.apply(this,arguments)}Object(i["a"])(t,[{key:"render",value:function(){var e
var n=this.props,r=n.wrap,i=n.weight,o=n.fontStyle,c=n.size,l=n.lineHeight,d=n.letterSpacing,g=n.transform,h=n.color,u=n.children
var m=Object(f["a"])(t,this.props)
return s.a.createElement(m,Object.assign({},Object(b["b"])(this.props),{className:p()((e={},Object(a["a"])(e,x.root,true),Object(a["a"])(e,x[c],c),Object(a["a"])(e,x["wrap-".concat(r)],r),Object(a["a"])(e,x["weight-".concat(i)],i),Object(a["a"])(e,x["style-".concat(o)],o),Object(a["a"])(e,x["transform-".concat(g)],g),Object(a["a"])(e,x["lineHeight-".concat(l)],l),Object(a["a"])(e,x["letterSpacing-".concat(d)],d),Object(a["a"])(e,x["color-".concat(h)],h),e)),ref:this.props.elementRef}),u)}}])
t.displayName="Text"
return t}(l["Component"]),R.propTypes={as:g.a.elementType,children:g.a.node,color:m["a"].deprecatePropValues(g.a.oneOf(["primary","secondary","brand","success","warning","error","danger","alert","primary-inverse","secondary-inverse"]),["error"],"It will be removed in version 8.0.0. Use `danger` instead."),elementRef:g.a.func,fontStyle:g.a.oneOf(["italic","normal"]),letterSpacing:g.a.oneOf(["normal","condensed","expanded"]),lineHeight:g.a.oneOf(["default","fit","condensed","double"]),size:g.a.oneOf(["x-small","small","medium","large","x-large","xx-large"]),transform:g.a.oneOf(["none","capitalize","uppercase","lowercase"]),weight:g.a.oneOf(["normal","light","bold"]),wrap:g.a.oneOf(["normal","break-word"])},R.defaultProps={as:"span",wrap:"normal",size:"medium",letterSpacing:"normal",children:null,elementRef:void 0,color:void 0,transform:void 0,lineHeight:void 0,fontStyle:void 0,weight:void 0},w))||k)},dDTa:function(e,n,t){"use strict"
const a=()=>{const e=ENV.LTI_LAUNCH_FRAME_ALLOWANCES||[]
return e.join("; ")}
n["a"]=a},dpqJ:function(e,n,t){"use strict"
t.d(n,"a",(function(){return o}))
var a=t("q1tI")
var r=t.n(a)
var i=t("ZELe")
var o={oneOf:function(e){function n(n,t,a){var i=r.a.Children.toArray(n[t])
var o=e.map((function(e){return e?c(e):e}))
for(var l=0;l<i.length;l++){var s=i[l]
if(s&&s.type){var d=c(s.type)
if(o.indexOf(d)<0)return new Error("Expected one of ".concat(o.join(", ")," in ").concat(a," but found '").concat(d,"'"))}else if(s)return new Error("Expected one of ".concat(o.join(", ")," in ").concat(a," but found an element with unknown type: ").concat(s))}}n.isRequired=Object(i["a"])(n)
return n},oneOfEach:function(e){return function(n,t,a){var i=r.a.Children.toArray(n[t])
var o={}
var l=e.map((function(e){var n=c(e)
o[n]=0
return n}))
for(var s=0;s<i.length;s++){var d=i[s]
if(d&&d.type){var g=c(d.type)
if(l.indexOf(g)<0)return new Error("Expected one of ".concat(l.join(", ")," in ").concat(a," but found '").concat(g,"'"))
o[g]=(o[g]||0)+1}else if(d)return new Error("Expected one of ".concat(l.join(", ")," in ").concat(a," but found an element of unknown type: ").concat(d))}var h=[]
Object.keys(o).forEach((function(e){o[e]>1&&h.push("".concat(o[e]," children of type ").concat(e))
0===o[e]&&h.push("0 children of type ".concat(e))}))
if(h.length>0)return new Error("Expected exactly one of each ".concat(l.join(", ")," in ").concat(a," but found:\n  ").concat(h.join("\n")))}},enforceOrder:function(){for(var e=arguments.length,n=new Array(e),t=0;t<e;t++)n[t]=arguments[t]
function a(e,n){for(var t=0;t<e.length;t++)if(e[t]!==n[t])return false
return true}function o(e,n){return n.map((function(n){return l(e,n)})).join("\n\n")}function l(e,n){var t=n.map((function(e){return e?c(e):"??"})).map((function(e){return"  <".concat(e," />")})).join("\n")
return"<".concat(e,">\n").concat(t,"\n</").concat(e,">")}function s(e,t,i){var s=r.a.Children.toArray(e[t]).map((function(e){if(e&&e.type)return c(e.type)
if(e)return null}))
for(var d=0;d<n.length;d++){var g=n[d].map((function(e){return e?c(e):"??"}))
if(a(s,g))return}return new Error("Expected children of ".concat(i," in one of the following formats:\n  ").concat(o(i,n),"\n\n\n  Instead of:\n  ").concat(l(i,s)))}s.isRequired=Object(i["a"])(s)
return s}}
var c=function(e){return"string"===typeof e?e:e.displayName||e.name}},msMH:function(e,n,t){"use strict"
